 ...
 *
 * The example of the calculation (example for horizontal lane,
 * where most left element is always focused)
 ...
 * As the last movement was done in the direction of rangeEnd
 * (in case of horizontal lane, to the right side)
 *
 ...
 * @param {number} lastMovementDirection - 1 the last movement was done to the end of the range
 *                 if -1 - then to the beginning
 */
